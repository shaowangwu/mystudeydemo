...
class MyThread03 implements Callable<Integer>
{
    ...
    public Integer call() throws Exception {
        System.out.println("-----come in Callable MyThread03--------");
...
public class CallableDemo03
{
    ...
    public static void main(String[] args) throws ExecutionException, InterruptedException {
        ...
        t1.start();*/
        //同一个MyThread03对象构造的futureTask，只打印一次MyThread03里的方法。
        new Thread(futureTask,"AA-futureTask").start();
        new Thread(futureTask,"BB-futureTask").start();
